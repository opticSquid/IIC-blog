  ...
  return (
    <div className="main">
        ...
        <div className="navbar">
            <img className="logo" src={mobile ? logo2 : logo1} style={mobile ? { transform: "scale(0.4)" } : null} alt="default Img"></img>
            <div className="socialMediaL">
                <a href="https://www.facebook.com/iictmsl/" target="_blank" rel="noreferrer">
                    <img src={mobile ? facebook1 : facebook} width="20px" height="20px" alt="facebook"></img>
                </a>
                <a href="https://twitter.com/iictmsl" target="_blank" rel="noreferrer">
                    <img src={mobile ? twitter1 : twitter} width="20px" height="20px" alt="twitter"></img>
                </a>
                <a href="https://www.instagram.com/iictmsl/" target="_blank" rel="noreferrer">
                    <img src={mobile ? insta1 : insta} width="20px" height="20px" alt="insta"></img>
                </a>
